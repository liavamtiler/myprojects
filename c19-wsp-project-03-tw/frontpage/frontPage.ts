...
// import { productDetails } from "./route/productdetailsrouter/productdetails";
// import { register } from "./route/registerrouter/register";
// import { login } from "./route/loginrouter/login";
// import {searchBar} from "./route/searching/search"
// import { history} from './route/historyrouter/history'
// import { getHistory} from './route/shoppingHistoryrouter/shoppingHistory'
// import { deleteItem} from './route/deleteItemFromCart/deletItem'
// import {updateSold}  from './route/updatesold/updatesold'
// import {newProducts} from './route/newproductRouter/newProduct'


const knex:any = Knex(knexConfig["development"])// 有呢個先開到knex
